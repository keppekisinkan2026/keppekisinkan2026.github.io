...
const welcomeEventDefinitions = [
  ...
  { id: "ev17", date: "4/17", dates: eventDates("2026-04-17"), title: "女子会", description: "女子同士で楽しく交流できるイベントです！演劇のことから大学生活のことまで、ケッペキの先輩と気軽に話してみませんか？※上演会からの変更になります", position: { top: "59%", left: "63%", width: "12.0%", height: "12.0%" } },
